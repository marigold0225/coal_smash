...
void initializeConfigFromParser(config_in &config, const config_parser &read_config_parser) {
    ...
    //deutron
    config.deuteron.dpt          = read_config_parser.get_double("d_dpt");
    ...
    //alpha
    config.alpha.dpt          = read_config_parser.get_double("alpha_dpt");
    ...
    //Be
    config.Be.dpt          = read_config_parser.get_double("Be_dpt");
